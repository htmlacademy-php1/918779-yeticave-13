  <main>
    ...
    <form class="form form--add-lot container <?= $classname; ?>" action="add.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
      ...
      <div class="form__item form__item--wide <?= $classname; ?>">
        ...
        <textarea id="message" name="user_description" placeholder="Напишите описание лота"></textarea>
      ...
      <?php $classname = isset($errors["price"]) ? "form__item--invalid" : ""; ?>  
        ...
        <div class="form__item <?= $classname; ?>">
          ...
          <input class="form__input-date" id="lot-date" type="text" name="date_expiration" placeholder="Введите дату в формате ГГГГ-ММ-ДД">
