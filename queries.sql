...
VALUES (6000, 1, 6, '2021-08-22'), (8500, 2, 6, '2021-08-23');
...
SELECT lots.lot_name, lots.price, lots.photo, categories.category_name, bets.sum
FROM lots 
JOIN categories ON lots.category_id=categories.id
JOIN bets ON bets.sum 
WHERE lots.date_expiration > NOW() AND bets.id = LAST_INSERT_ID();
